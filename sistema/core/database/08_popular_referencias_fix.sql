...
-- ================================================================================
-- Additional indexes for configuration table
CREATE INDEX IF NOT EXISTS idx_config_categoria_ativo ON configuracoes_sistema(categoria, ativo);
CREATE INDEX IF NOT EXISTS idx_config_tipo_valor ON configuracoes_sistema(tipo_valor);
...
-- ================================================================================
-- ADICIONAR FOREIGN KEYS APÓS POPULAÇÃO DOS DADOS
-- ================================================================================

-- Adicionar Foreign Key para moedas (agora que moedas_referencia está populada)
ALTER TABLE adicoes
ADD CONSTRAINT fk_adicoes_moeda FOREIGN KEY (moeda_codigo) 
    REFERENCES moedas_referencia(codigo_siscomex);

-- ================================================================================
-- END OF REFERENCE DATA POPULATION - VERSÃO CORRIGIDA
-- ================================================================================